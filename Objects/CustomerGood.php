...
#dec18th2022--copmment out return for the table for loop--line 104--temporsary
...
//dec17th20222--1130am00i cant get count outpour but no erros in syuntax
...
public function __construct($newCustomerId = "", $newName = "")
{
 ...
 //dec17th2022 thsi made us find cointrcutor mispeel above
//echo "test $newName";
}
     ...
     global $connection;
      ...
      if($rows->execute())
      {
          ...
          if($row = $rows->fetch(PDO::FETCH_ASSOC))
          {
            ...
            $this->name = $row["name"];
            //comment out for now 
            //dec18th2022--comment out for now the return--
